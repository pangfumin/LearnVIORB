...
{
public:
    void static GlobalBundleAdjustmentNavState(SLAMMap* pMap,
                                               const cv::Mat& gw,
                                               int nIterations,
                                               bool* pbStopFlag,
...
public:
    ...
    void static GlobalBundleAdjustemnt(SLAMMap* pMap,
                                       int nIterations=5,
                                       bool *pbStopFlag=NULL,
                                       const unsigned long nLoopKF=0,
                                       const bool bRobust = true);
    ...
    void static OptimizeEssentialGraph(SLAMMap* pMap, KeyFrame* pLoopKF, KeyFrame* pCurKF,
