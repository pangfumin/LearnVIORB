...
class parse_bundler
{
  public:
    ...
    // Parses the output text file generated by orbslam.
    // Input parameters: The filename of the output file (usually map.bin)
    bool parse_data( const char* orbslam_out_filename_ );
